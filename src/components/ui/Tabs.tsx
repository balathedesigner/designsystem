...
type TabsComponent = React.ForwardRefExoticComponent<TabsProps & React.RefAttributes<HTMLDivElement>> & {
...
const Tabs = React.forwardRef<
  ...
  TabsProps
>(({ className, variant = 'default', orientation = 'horizontal', size = 'md', fullWidth, ...props }, ref) => (
  <TabsPrimitive.Root
    ref={ref}
...
// Add compound components to Tabs
Tabs.List = TabsList;
